...
function DraggableHeaderStrip({
    ...
    return (
        <div
            ...
            {...attributes}
            {...listeners}
            className={`relative h-8 cursor-grab overflow-hidden rounded-t-lg shadow-sm transition-all active:cursor-grabbing ${
        ...
        >
            {card.printing?.image_url ? (
                ...
                <div className="pointer-events-none flex h-full w-full items-center justify-center bg-zinc-800 px-2">
            ...
            {isHovered && (
                <div className="pointer-events-none absolute inset-0 flex items-center justify-end gap-1 bg-black/40 px-1">
                    <button
                        onPointerDown={(e) => e.stopPropagation()}
                        onClick={(e) => e.stopPropagation()}
                        onMouseEnter={() => onShowPreview(card)}
                        onMouseLeave={onHidePreview}
                        className="pointer-events-auto flex h-5 w-5 items-center justify-center rounded-full bg-primary text-primary-foreground shadow"
                    >
                    ...
                    <button
                        ...
                        className="pointer-events-auto flex h-5 w-5 items-center justify-center rounded-full bg-destructive text-destructive-foreground shadow"
                    >
    ...
    return (
        <div
            ...
            className={`relative w-full cursor-grab overflow-hidden active:cursor-grabbing ${
                isHovered ? 'z-10 rounded ring-2 ring-primary' : ''
            } ${isInDeck ? 'grayscale' : ''}`}
            onMouseEnter={() => onHover(card.id)}
            onMouseLeave={() => {
                onHover(null);
        ...
        >
            {card.printing?.image_url ? (
                ...
                <div className="pointer-events-none flex h-full w-full items-center justify-center bg-muted px-2">
            ...
            {isHovered && (
                <div className="pointer-events-none absolute inset-0 flex items-center justify-end gap-1 bg-black/50 px-1">
                    <button
                        onPointerDown={(e) => e.stopPropagation()}
                        onClick={(e) => e.stopPropagation()}
                        onMouseEnter={() => onShowPreview(card)}
...
function DraggableListItem({
    ...
    return (
        <div
            ...
            {...attributes}
            {...listeners}
            className={`group flex cursor-grab items-center gap-2 rounded p-1.5 text-sm active:cursor-grabbing ${
                isInDeck ? 'opacity-50' : ''
            } hover:bg-accent`}
            onMouseEnter={() => onShowPreview(card)}
            onMouseLeave={onHidePreview}
        ...
        >
            {card.printing?.image_url ? (
                <img
                    src={card.printing.image_url}
                    alt={card.printing.card?.name ?? ''}
                    className={`pointer-events-none max-h-full max-w-full rounded-lg shadow-md transition-all duration-200 ${
                        isHovered ? 'shadow-xl ring-2 ring-primary' : ''
                    } ${isInDeck ? 'grayscale' : ''}`}
                />
            ) : (
                <div
                    className={`pointer-events-none flex aspect-[2.5/3.5] w-full items-center justify-center rounded-lg bg-muted text-center text-xs text-muted-foreground shadow-md ${
                        isHovered ? 'shadow-xl ring-2 ring-primary' : ''
                    } ${isInDeck ? 'grayscale' : ''}`}
                >
            ...
            {isHovered && !isDragging && (
                <div className="pointer-events-none absolute top-1 right-1 flex gap-1">
                    <button
                        ...
                        onMouseEnter={() => onShowPreview(card)}
                        onMouseLeave={onHidePreview}
                        className="pointer-events-auto flex h-6 w-6 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-lg transition-transform hover:scale-110"
                    >
                        <Eye className="h-3 w-3" />
                    </button>
                    <button
                        ...
                        className="pointer-events-auto flex h-6 w-6 items-center justify-center rounded-full bg-destructive text-destructive-foreground shadow-lg transition-transform hover:scale-110"
                    >
                        <Trash2 className="h-3 w-3" />
                    </button>
                </div>
            ...
            {isHovered && (
                <div className="pointer-events-none absolute inset-0 flex items-center justify-end gap-1 bg-black/50 px-1">
                    <button
                        ...
                        onMouseEnter={() => onShowPreview(card)}
                        onMouseLeave={onHidePreview}
                        className="pointer-events-auto flex h-4 w-4 items-center justify-center rounded-full bg-primary text-primary-foreground shadow"
                    >
                    ...
                    <button
                        ...
                        className="pointer-events-auto flex h-4 w-4 items-center justify-center rounded-full bg-destructive text-destructive-foreground shadow"
                    >
